...
import (
	...
	"github.com/JuD4Mo/broker-service/event"
	"github.com/JuD4Mo/broker-service/logs"
...
func (app *Config) authenticate(w http.ResponseWriter, a AuthPayload) {
	...
	//call the service
	request, err := http.NewRequest("POST", "http://authentication-service:82/authenticate", bytes.NewBuffer(jsonData))
	if err != nil {
		app.errorJSON(w, err)
		return
	}
...
func (app *Config) pushToQueue(name, msg string) error {
	emmiter, err := event.NewEventEmmiter(app.RabbitMQ)
	if err != nil {
		return err
	}
